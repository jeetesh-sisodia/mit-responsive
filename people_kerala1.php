...
<div class="container">	
	...
	<div class="row">
      	...
      	<div class="col-lg-2">
			<ul class="contab">
				<li class="consubtab" style="padding-bottom:9%;"><img src="assets/img/gray.png" style="width:10px;height:10px;">&nbsp;&nbsp;<a href="project_kerala.php" style="text-decoration:none;color:#acacac;">Recap</a></li>
				<li class="consubtab" style="padding-bottom:9%;"><img src="assets/img/gray.png" style="width:10px;height:10px;">&nbsp;&nbsp;<a href="about_kerala.php" style="text-decoration:none;color:#acacac;">About</a></li>
				<li class="consubtab" style="padding-bottom:9%;"><img src="assets/img/gray.png" style="width:10px;height:10px;">&nbsp;&nbsp;<a href="track_kerala.php" style="text-decoration:none;color:#acacac;">Tracks</a></li>
				<li class="consubtab" style="padding-bottom:9%;"><img src="assets/img/orange.png" style="width:10px;height:10px;">&nbsp;&nbsp;<a href="people_kerala.php" style="text-decoration:none;color:black;">People</a></li>
				<li class="consubtab" style="padding-bottom:9%;"><img src="assets/img/gray.png" style="width:10px;height:10px;">&nbsp;&nbsp;<a href="sponsors_kerala.php" style="text-decoration:none;color:#acacac;">Sponsors</a></li>
			</ul>
        </div>
      	...
      	<div class="col-lg-8">
              <div class="row">
              	...
              	<div class="col-lg-8">
              		<br/>
              		<img src="assets/img/header_kerala.jpg" class="img-responsive"/></div>
              	<div class="col-lg-2"></div>              	
              </div>
              <div class="row" id="people">
				<div class="col-lg-4"></div>
				<div class="col-lg-4"><h3 class="orange_labels"><center>Instructor</center></h3></div>
				<div class="col-lg-4"></div>
	</div>
	...
	<div class="row">
		<div class="img-grid">
			<ul>
				<li>
					<div class="col-lg-12 boxgrid captionfull">
				...
				<li>
					<div class="col-lg-12 boxgrid captionfull">
						...
						<div class="cover boxcaption">
						<h4><center>Dhairya Dand</center></h4>
						<p></p>
						</div>
					</div>
				</li>
...
?>
	...
	<div class="reveal-modal" id="KshitijMarwah" >
		<div class="row" style="padding-top:25px">
			<h3 style="color:gray;font-family:MuseoSlab;">Kshitij Marwah</h3>
		</div>
		<hr>
		<p style="text-align:justify;margin: 0 0 15px 0;">
			<img src="content/diy/kerala/instructors/KshitijMarwah.png" style="float:left;margin: 0px 10px 5px 0px;" class="img-responsive"/>
